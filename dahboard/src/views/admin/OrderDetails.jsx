            ...
            <div className=" w-[32%]">
              <div className=" pr-3 text-[#d0d2d6] text-lg">
                <div className=" flex flex-col gap-1">
                  <h2 className=" pb-2 font-semibold">Delivered to: Vaskar</h2>
                  <p>
                    <span className=" text-sm">
                      Rajshahi, rak, bolia,House no #32
                    </span>
                  </p>
                </div>
                <div className=" flex justify-start items-center gap-3">
                  <h2>Payment Status</h2>
                  <span className=" text-bases">Paid</span>
                </div>
                <span>Price: $6767</span>
