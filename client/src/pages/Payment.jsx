                ...
                <div className=" flex flex-wrap ">
                  ...
                  >
                    <div className=" flex flex-col gap-[3px] justify-center items-center">
                      ...
                      <san className=" text-slate-600">Stripe</san>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className=" flex flex-col gap-[3px] justify-center items-center">
                      ...
                      <san className=" text-slate-600">Bkash</san>
                    </div>
                  </div>
                  <div
                    onClick={() => setPaymentMethod("rocket")}
                    className={`w-[20%] border-r cursor-pointer py-8 px-12 ${
                      paymentMethod === "rocket" ? "bg-white" : "bg-slate-100"
                    }`}
                  >
                    <div className=" flex flex-col gap-[3px] justify-center items-center">
                      <img src="/images/payment/rocket.png" alt="rocket" />
                      <san className=" text-slate-600">Rocket</san>
                    </div>
                  </div>
                  <div
                    onClick={() => setPaymentMethod("nogod")}
                    className={`w-[20%] border-r cursor-pointer py-8 px-12 ${
                      paymentMethod === "nogod" ? "bg-white" : "bg-slate-100"
                    }`}
                  >
                    <div className=" flex flex-col gap-[3px] justify-center items-center">
                      <img src="/images/payment/nogod.png" alt="nogod" />
                      <san className=" text-slate-600">Nogod</san>
                    </div>
                  </div>
                </div>
