...
import { get_products } from "../../store/Reducers/produtReducer";

const Products = () => {
  const dispatch = useDispatch();
  const { totalProduct, products } = useSelector((state) => state.product);
                ...
                <tr key={i}>
                  ...
                  >
                    <div className=" flex justify-start items-center gap-4">
                      ...
                      <button className=" p-3 bg-red-500 rounded hover:shadow-lg hover:shadow-red-500/50">
                        <FaTrash />
                      </button>
                    </div>
                  </td>
