...
import { FaFacebook, FaLinkedin, FaUser, FaLock, FaList } from "react-icons/fa";
import {
  AiOutlineTwitter,
  AiFillGithub,
  AiFillHeart,
        ...
        <div className=" w-[85%] lg:w-[90%] mx-auto">
          <div className=" flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className=" flex justify-start items-center gap-8">
              <li className=" flex justify-center items-center gap-2 relative text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] ">
                <span>
                  <GrMail />{" "}
                </span>
                <span>vaskar@gmail.com</span>
              </li>
            ...
            <div>
              <div className=" flex justify-center items-center gap-10">
                ...
                <div className=" flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] before:absolute before:h-[18px] before:w-[1px] before:bg-[#afafaf] before:-left-[20px] ">
                  <img src="/images/language.png" alt="" />
                  <span>
                    <MdKeyboardArrowDown />
                  </span>
                  <ul className=" absolute invisible group-hover:visible group-hover:top-6 group-hover:bg-black z-10 transition-all top-12 rounded-sm duration-200 text-white p-2 w-[100px] flex flex-col gap-3">
                    <li>Bangla</li>
                    <li>English</li>
                    <li>Hindi</li>
                    <li>Spanish</li>
                ...
                {userInfo ? (
                  <Link
                    className=" flex justify-center items-center text-sm cursor-pointer gap-2"
                    to="/dashboard"
                  >
                    <span>
                      <FaUser />
          ...
          <div className=" h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className=" md-lg:w-full w-3/12 md-lg:pt-4">
              <div className=" flex justify-between items-center ">
                ...
                <div
                  className=" justify-center items-center w-[30px] h-[30px] bg-white text-slate-600 border border-slate-600 rounded-md cursor-pointer lg:hidden md-lg:flex xl:hidden hidden"
        ...
        >
          <div className=" flex justify-start flex-col gap-6">
            ...
            <div className=" flex justify-start items-center gap-10">
              <div className=" flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                <img src="/images/language.png" alt="" />
                <span>
                  <MdKeyboardArrowDown />
                </span>
              ...
              {userInfo ? (
                ...
                <div className=" flex justify-center items-center text-sm cursor-pointer gap-2">
                  <span>
                    <FaLock />
                  </span>
                  <span>Login</span>
        ...
        <div className=" flex w-full flex-wrap md-lg:gap-8">
          <div className=" w-3/12 md-lg:w-full">
            <div className=" bg-white relative">
              ...
              >
                <ul className=" py-2 text-slate-600 font-medium overflow-auto h-full">
                  {categorys.map((c, i) => {
                    return (
                      <li
                        key={i}
                      ...
                      >
                        <img
                          src={c.image}
                          alt={c.name}
                          className=" w-[39px] h-[30px] rounded-full overflow-hidden"
                        />
                        <Link
          ...
          <div className=" w-9/12 pl-8 md-lg:pl-0 md-lg:w-full">
            <div className=" flex flex-wrap w-full justify-between ic md-lg:gap-6">
