            ...
            <div className=" w-4/12">
              <div className=" px-0 md:px-5 py-2">
                ...
                <div className=" flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md">
                  ...
                  <div className=" flex gap-2">
                    <span>Division:</span>
                    <span>{seller?.shopInfo?.divison}</span>
                  </div>
                  <div className=" flex gap-2">
                    <span>District:</span>
          ...
          <div>
            <form onSubmit={submit}>
              <div className=" flex gap-4 py-3">
                ...
                <button className=" bg-blue-500 w-[150px] hover:shadow-blue-500/50 hover:shadow-lg rounded-md px7 py-2">
                  Submit
                </button>{" "}
              </div>
            </form>
